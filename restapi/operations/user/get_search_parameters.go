...
// GetSearchMaxParseMemory sets the maximum size in bytes for
// the multipart form parser for this operation.
//
// The default value is 32 MB.
// The multipart parser stores up to this + 10MB.
var GetSearchMaxParseMemory int64 = 32 << 20
...
func (o *GetSearchParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if err := r.ParseMultipartForm(GetSearchMaxParseMemory); err != nil {
...
// bindUserID binds and validates parameter UserID from formData.
